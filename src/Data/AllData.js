...
import empImg from "../Images/EmpManagementAdminPanel.png";
...
export const projectData = [
  {
    ...
    frontend_git: "https://github.com/Sroopesh1122/todolist",
    backend_git: "https://github.com/Sroopesh1122/simple_server",
  ...
  },
  {
    ...
    img: empImg,
    desc: "The Employee Data Management System (Admin Panel) is a robust web application designed to facilitate the efficient management of employee information within an organization. This system empowers administrators to seamlessly add, update, and delete employee details, ensuring that all records are current and accurately maintained. In addition to handling textual data, the system allows for the uploading and storing of employee photos, which can be easily associated with their respective profiles. By providing a centralized and user-friendly interface, the Employee Data Management System streamlines the process of managing employee information, reducing administrative overhead and minimizing errors in data handling.",
    frontend_git: "https://github.com/Sroopesh1122/Emp_frontend",
    backend_git: "https://github.com/Sroopesh1122/Emp_server",
    demo: "https://sr-employees.netlify.app",
    technology: [
      {
        name: "React",
        icon: reactIcon,
